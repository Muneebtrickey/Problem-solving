...
"""
we need to modify the make_payment method so that if the user enter a negative number so it would raise a valueError.
"""
...
# now we are doing a payment

print(creditcard.make_payment(-50))